describe("CP08-RegistroDeLibro", () => {
  ...
  it("CP06-02 - Registro de Libro", () => {
    ...
    cy.get("#toast-container").should(
      "contain",
      'Debe completar el campo:"Codigo Barra"'
    );
    ...
    cy.get("#toast-container").should(
      "contain",
      'Debe completar el campo:"Isbn"'
    );
    cy.get("#btnGuardar").click();
    cy.get("#toast-container").should(
      "contain",
      'Debe completar el campo:"Titulo"'
    );
    cy.get("#txtTitulo").type("TituloTest");
    cy.get("#btnGuardar").click();
    cy.get("#toast-container").should(
      "contain",
      'Debe completar el campo:"Autor"'
    );
    cy.get("#txtAutor").type("AutorTest");
    cy.get("#btnGuardar").click();
    cy.get("#toast-container").should(
      "contain",
      'Debe completar el campo:"Stock"'
    );
    cy.get("#txtStock").type("Nan");
    cy.get("#btnGuardar").click();
    cy.get("#toast-container").should(
      "contain",
      "El campo stock debe ser un numero"
    );
    cy.get("#txtStock").clear().type(0);
    cy.get("#btnGuardar").click();
    cy.get("#toast-container").should(
      "contain",
