USE [master]
GO
/****** Object:  Database [BAE]    Script Date: 14/11/2023 12:10:10 p. m. ******/
CREATE DATABASE [BAE]
 CONTAINMENT = NONE
 ON  PRIMARY 
...
USE [BAE]
GO
/****** Object:  Table [dbo].[Configuracion]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[DetallePedido]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DetalleVenta]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Editorial]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Genero]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Libro]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Menu]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Negocio]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NumeroCorrelativo]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Pedido]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Rol]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RolMenu]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Tienda]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoDocumentoVenta]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Venta]    Script Date: 14/11/2023 12:10:10 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[DetallePedido] ([idDetallePedido], [idPedido], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (18, 44, 9, N'Ballantine Books', N'The Odyssey', N'Misterio', 12, CAST(12.00 AS Decimal(10, 2)), CAST(144.00 AS Decimal(10, 2)))
INSERT [dbo].[DetallePedido] ([idDetallePedido], [idPedido], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (19, 45, 4, N'Puffin Books', N'The Great Gatsby', N'Autobiografía', 12, CAST(12.00 AS Decimal(10, 2)), CAST(144.00 AS Decimal(10, 2)))
INSERT [dbo].[DetallePedido] ([idDetallePedido], [idPedido], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (20, 45, 9, N'Ballantine Books', N'The Odyssey', N'Misterio', 12, CAST(12.00 AS Decimal(10, 2)), CAST(144.00 AS Decimal(10, 2)))
INSERT [dbo].[DetallePedido] ([idDetallePedido], [idPedido], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (21, 46, 4, N'Puffin Books', N'The Great Gatsby', N'Autobiografía', 112, CAST(1.00 AS Decimal(10, 2)), CAST(112.00 AS Decimal(10, 2)))
INSERT [dbo].[DetallePedido] ([idDetallePedido], [idPedido], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (22, 47, 19, N'St. Martin Press', N'The Little Prince', N'Filosofia', 1, CAST(156.00 AS Decimal(10, 2)), CAST(156.00 AS Decimal(10, 2)))
...
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (13, 3, 19, N'St. Martin Press', N'The Little Prince', N'Filosofia', 2, CAST(59.90 AS Decimal(10, 2)), CAST(119.80 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (14, 4, 1, N'Dorling Kindersley', N'1984', N'Infantil', 2, CAST(123.45 AS Decimal(10, 2)), CAST(246.90 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (15, 5, 1, N'Dorling Kindersley', N'1984', N'Infantil', 3, CAST(123.45 AS Decimal(10, 2)), CAST(370.35 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (16, 6, 8, N'Pantheon Books', N'The Catcher in the Rye', N'Terror', 2, CAST(87.60 AS Decimal(10, 2)), CAST(175.20 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (17, 6, 4, N'Puffin Books', N'The Great Gatsby', N'Autobiografía', 2, CAST(74.30 AS Decimal(10, 2)), CAST(148.60 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (18, 7, 9, N'Ballantine Books', N'The Odyssey', N'Misterio', 2, CAST(92.10 AS Decimal(10, 2)), CAST(184.20 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (19, 7, 4, N'Puffin Books', N'The Great Gatsby', N'Autobiografía', 2, CAST(74.30 AS Decimal(10, 2)), CAST(148.60 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (20, 8, 9, N'Ballantine Books', N'The Odyssey', N'Misterio', 12, CAST(92.10 AS Decimal(10, 2)), CAST(1105.20 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (21, 9, 3, N'Alfred A. Knopf', N'To Kill a Mockingbird', N'Historico', 12, CAST(67.50 AS Decimal(10, 2)), CAST(810.00 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (22, 10, 12, N'Oxford University Press', N'Ulysses', N'Infantil', 2, CAST(97.40 AS Decimal(10, 2)), CAST(194.80 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (23, 10, 2, N'Doubleday', N'Brave New World', N'Ciencia Ficción', 2, CAST(89.90 AS Decimal(10, 2)), CAST(179.80 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (24, 10, 28, N'Macmillan Publishers', N'The Lord of the Rings', N'Arte', 2, CAST(105.30 AS Decimal(10, 2)), CAST(210.60 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (25, 10, 13, N'Abrams Books', N'One Hundred Years of Solitude', N'Juvenil', 2, CAST(101.75 AS Decimal(10, 2)), CAST(203.50 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (26, 10, 4, N'Puffin Books', N'The Great Gatsby', N'Autobiografía', 2, CAST(74.30 AS Decimal(10, 2)), CAST(148.60 AS Decimal(10, 2)))
INSERT [dbo].[DetalleVenta] ([idDetalleVenta], [idVenta], [idLibro], [editorialLibro], [tituloLibro], [generoLibro], [cantidad], [precio], [total]) VALUES (27, 10, 15, N'Dorling Kindersley', N'The Brothers Karamazov', N'Biografía', 2, CAST(113.90 AS Decimal(10, 2)), CAST(227.80 AS Decimal(10, 2)))
...
INSERT [dbo].[Libro] ([idLibro], [CodigoBarra], [isbn], [Titulo], [precio], [stock], [Autor], [urlImagen], [nombreImagen], [idGenero], [idEditorial], [esActivo], [fechaRegistro]) VALUES (1, N'9780451524935', N'0451524934', N'1984', CAST(123.45 AS Decimal(10, 2)), 95, N'George Orwell', N'https://firebasestorage.googleapis.com/v0/b/ventasasp-8d05c.appspot.com/o/IMAGENES_PRODUCTO%2F8e239d5159b34b13a1754ec2d4b24248.jpg?alt=media&token=98f67919-07b7-4176-b33a-b9b4bdbd4085', N'8e239d5159b34b13a1754ec2d4b24248.jpg', 12, 27, 1, CAST(N'2023-11-06T20:07:29.123' AS DateTime))
INSERT [dbo].[Libro] ([idLibro], [CodigoBarra], [isbn], [Titulo], [precio], [stock], [Autor], [urlImagen], [nombreImagen], [idGenero], [idEditorial], [esActivo], [fechaRegistro]) VALUES (2, N'9780451524936', N'0451524935', N'Brave New World', CAST(89.90 AS Decimal(10, 2)), 94, N'Aldous Huxley', N'https://firebasestorage.googleapis.com/v0/b/ventasasp-8d05c.appspot.com/o/IMAGENES_PRODUCTO%2Ffa0da145ca8345f8b5e39106d42c56aa.jpg?alt=media&token=9e0a4efd-8aac-4d69-b080-a45cae4c20e5', N'fa0da145ca8345f8b5e39106d42c56aa.jpg', 3, 15, 1, CAST(N'2023-11-06T20:07:29.123' AS DateTime))
...
INSERT [dbo].[Libro] ([idLibro], [CodigoBarra], [isbn], [Titulo], [precio], [stock], [Autor], [urlImagen], [nombreImagen], [idGenero], [idEditorial], [esActivo], [fechaRegistro]) VALUES (4, N'9780451524938', N'0451524937', N'The Great Gatsby', CAST(74.30 AS Decimal(10, 2)), 214, N'F. Scott Fitzgerald', N'https://firebasestorage.googleapis.com/v0/b/ventasasp-8d05c.appspot.com/o/IMAGENES_PRODUCTO%2F57cfc4da775e45bf98e31577d430aed4.jpg?alt=media&token=4c36225b-325a-4726-bf60-54407725a4b3', N'57cfc4da775e45bf98e31577d430aed4.jpg', 10, 32, 1, CAST(N'2023-11-06T20:07:29.123' AS DateTime))
...
INSERT [dbo].[Libro] ([idLibro], [CodigoBarra], [isbn], [Titulo], [precio], [stock], [Autor], [urlImagen], [nombreImagen], [idGenero], [idEditorial], [esActivo], [fechaRegistro]) VALUES (9, N'9780451524943', N'0451524942', N'The Odyssey', CAST(92.10 AS Decimal(10, 2)), 114, N'Homer', N'https://firebasestorage.googleapis.com/v0/b/ventasasp-8d05c.appspot.com/o/IMAGENES_PRODUCTO%2F3e3cdc35268b416aae1c7938ad5f3175.jpg?alt=media&token=ba4d02cd-23f2-42de-9888-10b98bad0fe3', N'3e3cdc35268b416aae1c7938ad5f3175.jpg', 8, 24, 1, CAST(N'2023-11-06T20:07:29.123' AS DateTime))
...
INSERT [dbo].[NumeroCorrelativo] ([idNumeroCorrelativo], [ultimoNumero], [cantidadDigitos], [gestion], [fechaActualizacion]) VALUES (1, 10, 6, N'venta', CAST(N'2023-11-14T11:57:02.063' AS DateTime))
INSERT [dbo].[NumeroCorrelativo] ([idNumeroCorrelativo], [ultimoNumero], [cantidadDigitos], [gestion], [fechaActualizacion]) VALUES (2, 47, 6, N'Pedido', CAST(N'2023-11-14T10:54:07.270' AS DateTime))
SET IDENTITY_INSERT [dbo].[NumeroCorrelativo] OFF
GO
SET IDENTITY_INSERT [dbo].[Pedido] ON 

INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (41, N'000041', 1, 1, 32, CAST(144.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-10T23:54:56.110' AS DateTime), NULL)
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (42, N'000042', 1, 1, 24, CAST(144.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-11T00:11:57.030' AS DateTime), NULL)
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (43, N'000043', 1, 1, 22, CAST(144.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-13T10:29:15.777' AS DateTime), NULL)
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (44, N'000044', 1, 1, 38, CAST(144.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-13T10:59:55.803' AS DateTime), NULL)
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (45, N'000045', 1, 1, 23, CAST(288.00 AS Decimal(10, 2)), 1, CAST(N'2023-11-13T11:04:56.500' AS DateTime), CAST(N'2023-11-13T14:13:53.310' AS DateTime))
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (46, N'000046', 1, 1, 35, CAST(112.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-13T15:01:44.493' AS DateTime), NULL)
INSERT [dbo].[Pedido] ([idPedido], [numeroPedido], [idTipoDocumentoPedido], [idUsuario], [idTienda], [Total], [estado], [fechaRegistro], [fechaEntrega]) VALUES (47, N'000047', 1, 1, 31, CAST(156.00 AS Decimal(10, 2)), 0, CAST(N'2023-11-14T10:54:07.353' AS DateTime), NULL)
...
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (3, N'000003', 1, 1, N'20172557628', N'UNIVERSIDAD NACIONAL DE TRUJILLO', CAST(101.53 AS Decimal(10, 2)), CAST(18.27 AS Decimal(10, 2)), CAST(119.80 AS Decimal(10, 2)), CAST(N'2023-11-08T21:49:15.617' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (4, N'000004', 1, 1, N'20172557628', N'UNIVERSIDAD NACIONAL DE TRUJILLO', CAST(209.24 AS Decimal(10, 2)), CAST(37.66 AS Decimal(10, 2)), CAST(246.90 AS Decimal(10, 2)), CAST(N'2023-11-09T23:59:40.683' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (5, N'000005', 1, 1, N'20172557628', N'UNIVERSIDAD NACIONAL DE TRUJILLO', CAST(313.86 AS Decimal(10, 2)), CAST(56.49 AS Decimal(10, 2)), CAST(370.35 AS Decimal(10, 2)), CAST(N'2023-11-10T00:04:52.977' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (6, N'000006', 1, 1, N'20172557628', N'UNIVERSIDAD NACIONAL DE TRUJILLO', CAST(274.41 AS Decimal(10, 2)), CAST(49.39 AS Decimal(10, 2)), CAST(323.80 AS Decimal(10, 2)), CAST(N'2023-11-10T00:12:13.700' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (7, N'000007', 1, 1, N'20172557628', N'UNIVERSIDAD NACIONAL DE TRUJILLO', CAST(282.03 AS Decimal(10, 2)), CAST(50.77 AS Decimal(10, 2)), CAST(332.80 AS Decimal(10, 2)), CAST(N'2023-11-10T19:05:30.433' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (8, N'000008', 1, 1, N'20107798049', N'UNIVERSIDAD DE LIMA', CAST(936.61 AS Decimal(10, 2)), CAST(168.59 AS Decimal(10, 2)), CAST(1105.20 AS Decimal(10, 2)), CAST(N'2023-11-10T22:42:03.513' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (9, N'000009', 1, 1, N'20107798049', N'UNIVERSIDAD DE LIMA', CAST(686.44 AS Decimal(10, 2)), CAST(123.56 AS Decimal(10, 2)), CAST(810.00 AS Decimal(10, 2)), CAST(N'2023-11-13T10:54:28.277' AS DateTime))
INSERT [dbo].[Venta] ([idVenta], [numeroVenta], [idTipoDocumentoVenta], [idUsuario], [documentoCliente], [nombreCliente], [subTotal], [impuestoTotal], [Total], [fechaRegistro]) VALUES (10, N'000010', 1, 1, N'20141878477', N'UNIVERSIDAD PRIVADA ANTENOR ORREGO', CAST(987.37 AS Decimal(10, 2)), CAST(177.73 AS Decimal(10, 2)), CAST(1165.10 AS Decimal(10, 2)), CAST(N'2023-11-14T11:57:02.097' AS DateTime))
