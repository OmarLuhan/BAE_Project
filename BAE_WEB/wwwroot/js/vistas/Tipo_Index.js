...
$("#btnGuardar").click(function () {
    ...
    modelo["idTipo"] = parseInt($("#txtId").val());
    ...
    if (modelo.idTipo == 0) {
        fetch("/Tipo/Crear", {
            ...
            if (responseJson.estado) {
                ...
                swal("Listo!", "Tipo de producto creado", "success");
            } else {
    ...
    swal({
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Tipo/Eliminar?idTipo=${data.idTipo}`, {
                    method: "DELETE"
                }).then(response => {
